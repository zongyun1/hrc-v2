...
class StockingBreakfastFoods(LwTaskBase):
    ...
    task_name: str = "StockingBreakfastFoods"
    cab_id1: FixtureType = FixtureType.CABINET
    cab_id2: FixtureType = FixtureType.CABINET
    ...
    def get_ep_meta(self):
        ...
        obj_name_1 = OU.get_obj_lang(self, "obj1")
        obj_name_2 = OU.get_obj_lang(self, "obj2")
    ...
    def _get_obj_cfgs(self):
        ...
        cfgs.append(
            dict(
                ...
                exclude_obj_groups="cookies",  # Temporarily removed because it's too large to grasp.
                graspable=True,
                placement=dict(
    ...
    def _check_success(self, env):
        obj1_inside_cab1 = OU.obj_inside_of(env, "obj1", self.cab1)
        obj2_inside_cab2 = OU.obj_inside_of(env, "obj2", self.cab2)
        gripper_objs_far = OU.gripper_obj_far(env, "obj1") & OU.gripper_obj_far(
            env, "obj2"
        )

        return obj1_inside_cab1 & obj2_inside_cab2 & gripper_objs_far
