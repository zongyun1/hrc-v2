...
from lw_benchhub_tasks.lightwheel_libero_tasks.base.libero_put_on_stove_base import PutMokaPotOnStoveBase


class L90K8PutTheRightMokaPotOnTheStove(PutMokaPotOnStoveBase):
