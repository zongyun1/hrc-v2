...
class LSPickUpTheBlackBowlNextToThePlateAndPlaceItOnThePlate(PutBlackBowlOnPlate):

    task_name: str = 'LSPickUpTheBlackBowlNextToThePlateAndPlaceItOnThePlate'
    ...
    def get_ep_meta(self):
        ...
        ep_meta[
            "lang"
        ] = f"Pick the akita black bowl next to the plate and place it on the plate."
        return ep_meta
