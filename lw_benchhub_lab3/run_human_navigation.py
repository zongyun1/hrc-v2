...
sys.path[:0] = [str(ROOT), str(ROOT.parent), str(ROOT.parent / "hrc-v2"), str(ROOT / 'source'),
                str(ROOT / 'source/third_party/IsaacLab-Arena')]
...
try:
    ...
    from navigation import aisle_scenario, clearance, base_command, yaw_xyzw, wrap
    from robot_materials import restore_panda_white
